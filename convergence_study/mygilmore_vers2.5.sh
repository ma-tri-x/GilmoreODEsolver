...
${scriptpath}/mygilmore_vers2.5 $Rstart $RdotStart $Rn $deltaT $Tstart $Tend $patm $pac $f $mu $sigma $BTait $nTait $kappa $pv $rho0 $SpecGasConst $TempRef $T0 $epsilon $phase $Rn2 $t_transit_start $t_transit_end
